const topnavbar = "#1e2833";
const sidebar = "#003247";
const darkersidebar = "#013f5a";
const backcolor = "#bdedfe";
const lightblue = "#dcf5ff";
const white = "#fff";
const black = "#000";
const grayblue = "#506479";
const extralightblue = "#e7f2fd";
